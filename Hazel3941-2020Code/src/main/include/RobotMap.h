...
static constexpr int DRIVE_CONTROLLER_LEFT_TRIGGER_BUTTON  = 5;
static constexpr int DRIVE_CONTROLLER_SHIFT_BUTTON = DRIVE_CONTROLLER_LEFT_TRIGGER_BUTTON;
...
static constexpr int OPERATOR_INTAKE_FEED_ROBOT_BUTTON = OPERATOR_JOYSTICK_HAT_LEFT_TOP;
